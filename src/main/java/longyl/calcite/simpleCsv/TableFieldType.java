...
enum TableFieldType {
  ...
  private static final Map<String, TableFieldType> MAP =
    new HashMap<String, TableFieldType>();
  ...
  TableFieldType(Primitive primitive) {
    this(primitive.boxClass, primitive.primitiveClass.getSimpleName());
  }

  TableFieldType(Class clazz, String simpleName) {
    this.clazz = clazz;
  ...
  public static TableFieldType of(String typeString) {
